            ...
            <div class="idle-details-container">
                ...
                <div class="details-info">
                    ...
                    <div class="details-picture">
                        <el-image v-for="(imgUrl, i) in idleItemInfo.pictureList" style="width: 90%;margin-bottom: 2px;"
                            :src="imgUrl" fit="contain"></el-image>
                    </div>
                </div>
                ...
                <div class="message-container" id="replyMessageLocation">
                    ...
                    <div class="message-send">
                        ...
                        <el-input type="textarea" autosize placeholder="留言提问..." v-model="messageContent" maxlength="200"
                            show-word-limit>
                        </el-input>
                        ...
                        <div v-for="(mes, index) in messageList" class="message-container-list">
                            <div class="message-container-list-left">
                                ...
                                <div class="message-container-list-text">
                                    ...
                                    <div class="message-content" v-html="mes.content">
                                        <!-- {{mes.content}} -->
                                    </div>
    ...
    created() {
        ...
        this.$api.getIdleItem({
            ...
            if (res.data) {
                ...
                res.data.pictureList = res.data.pictureList;
