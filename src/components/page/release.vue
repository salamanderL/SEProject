        ...
        <app-body>
            <div class="release-idle-container">
                ...
                <div class="release-idle-container-form">
                    <el-input placeholder="请输入商品名称" v-model="idleItemInfo.idleName" maxlength="30" show-word-limit>
                    </el-input>
                    <el-input class="release-idle-detiles-text" type="textarea" autosize placeholder="请输入商品的详细说明"
                        v-model="idleItemInfo.idleDetails" maxlength="1000" show-word-limit>
                    </el-input>
                    <div class="release-idle-place">
                        <div class="release-tip">发货地区</div>
                        <el-cascader :options="options" v-model="selectedOptions" @change="handleChange" :separator="' '"
                            style="width: 90%;">
                        </el-cascader>
                    </div>
                    <div class="release-idle-place">
                        <div class="release-tip">物品数量</div>
                        <el-input-number v-model="idleItemInfo.idleNum" :precision="0" :step="1" :min='1' :max="10000000">
                            <div slot="prepend">数量</div>
                        </el-input-number>
                    </div>
                    <div class="release-idle-place">
                        <div class="release-tip">物品价格</div>
                        <el-input-number v-model="idleItemInfo.idlePrice" :precision="2" :step="0.01" :min='0.01'
                            :max="10000000">
                    ...
                    <div class="release-idle-container-picture">
                        ...
                        <el-upload action="http://localhost:8080/file/" :on-preview="fileHandlePreview"
                        ...
                        <div class="picture-list">
                            <el-image style="width: 600px;height:400px; margin-bottom: 2px;" fit="contain"
                                v-for="(img, index) in imgList" :src="img" :preview-src-list="imgList"></el-image>
                        </div>
...
export default {
    ...
    methods: {
        ...
        releaseButton() {
            ...
            this.idleItemInfo.userId = this.$globalData.userInfo.id
            console.log(this.idleItemInfo.userId);
            if (this.idleItemInfo.idleName &&
                this.idleItemInfo.idleDetails &&
                this.idleItemInfo.idlePlace &&
                this.idleItemInfo.idleNum &&
